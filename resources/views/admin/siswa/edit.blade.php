        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <form action="{{ route('siswa.update', $record->idsiswa) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            @if (auth()->user()->role == 2)
                                <input type="hidden" name="idkelas" id="idkelas" value="{{ $kelas[0]->idkelas }}">
                            @else
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kelurahan_desa" id="kelurahan_desa" class="form-control"
                                        value="{{ $record->kelurahan_desa }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="kecamatan_kota">Kecamatan/Kota</label>
                                    <input type="text" name="kecamatan_kota" id="kecamatan_kota" class="form-control"
                                        value="{{ $record->kecamatan_kota }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
