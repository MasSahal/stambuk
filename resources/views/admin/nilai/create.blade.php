...
@section('content')
    <div class="page-header">
        <h3 class="page-title">Form Nilai Siswa</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Form Nilai Siswa</li>
            </ol>
        </nav>
    </div>
    <section class="row">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <form action="{{ route('nilai.store') }}" method="post">
                        @csrf
                        @method('POST')
                        <input type="hidden" name="kelas" value="{{ $siswa->nama_kelas }}">
                                ...
                                @foreach ($mapel as $no => $m)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="id_transkrip[]" value="{{ $siswa->id_transkrip }}">
                                            {{-- # --}}
